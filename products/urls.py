...
urlpatterns = [
    ...
    path('auto-assign-subcategories/', views_web.auto_assign_subcategories, name='auto_assign_subcategories'),
    path('sync-full-categories/', views_web.sync_full_categories, name='sync_full_categories'),
