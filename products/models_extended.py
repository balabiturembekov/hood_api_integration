...
class Product(models.Model):
    ...
    ean = models.CharField(max_length=20, blank=True, verbose_name="EAN код")
    isbn = models.CharField(max_length=20, blank=True, verbose_name="ISBN")
    mpn = models.CharField(max_length=100, blank=True, verbose_name="MPN (номер производителя)")
    manufacturer = models.CharField(max_length=100, default='JV Möbel', verbose_name="Производитель")
    item_number = models.CharField(max_length=100, blank=True, verbose_name="Номер товара клиента")
    ...
    packaging_size = models.CharField(max_length=100, blank=True, verbose_name="Размер упаковки")
    ...
    packaging_unit = models.CharField(max_length=10, choices=PACKAGING_UNIT_CHOICES, blank=True, verbose_name="Единица упаковки")
    ...
    category2_id = models.CharField(max_length=20, blank=True, verbose_name="Вторая категория")
    item_name_sub_title = models.CharField(max_length=200, blank=True, verbose_name="Подзаголовок товара")
    ...
    prod_cat_id = models.CharField(max_length=20, blank=True, verbose_name="ID категории магазина")
    prod_cat_id2 = models.CharField(max_length=20, blank=True, verbose_name="Дополнительная категория магазина")
    prod_cat_id3 = models.CharField(max_length=20, blank=True, verbose_name="Третья категория магазина")
    ...
    fsk = models.CharField(max_length=10, choices=FSK_CHOICES, blank=True, verbose_name="Возрастные ограничения")
    ...
    usk = models.CharField(max_length=10, choices=USK_CHOICES, blank=True, verbose_name="Возрастные ограничения USK")
    ...
    energy_efficiency_class = models.CharField(max_length=5, choices=ENERGY_EFFICIENCY_CHOICES, blank=True, verbose_name="Класс энергоэффективности")
    energy_label_url = models.URLField(blank=True, verbose_name="Ссылка на энергетическую этикетку")
    product_info_url = models.URLField(blank=True, verbose_name="Ссылка на технический паспорт")
    deficiency_description = models.TextField(blank=True, verbose_name="Описание дефектов")
